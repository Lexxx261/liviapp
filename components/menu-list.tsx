...
// Lista de categorías antes de su uso
...
// Componente ListItem antes de su uso
                ...
                <NavigationMenuLink asChild>
                  ...
                  >
                    <div className="cursor-pointer" onClick={() => router.push("/")}>
                      <Image src="/assets/logos/logo-n.png" alt="Logo" width={100} height={100} />
                    </div>
                    <div className="mb-2 mt-4 text-lg font-bold">Livi App</div>
